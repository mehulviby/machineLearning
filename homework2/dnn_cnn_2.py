...
def main(main_params):
    ...
    for t in range(num_epoch):
        ...
        for i in range(int(np.floor(N_train / minibatch_size))):
            ...
            # TODO (2)
            a22 = model['C2'].forward(m1)
            h22 = model['nonlinear2'].forward(a22)
            m2 = model['M2'].forward(h22)
            ################################################################################
            #                            End of TODO (2)                                   #
            ################################################################################
            ...
            # TODO (3)
            grad_m22= model['M2'].backward(h22, grad_m2) 
            grad_h22 = model['nonlinear2'].backward(a22, grad_m22)
            grad_m1 = model['C2'].backward(m1,grad_h22)
            ################################################################################
            #                            End of TODO (3)                                   #
            ################################################################################
        ...
        for i in range(int(np.floor(N_train / minibatch_size))):
            ...
            # TODO (4)
            a24 = model['C2'].forward(m1)
            h24 = model['nonlinear2'].forward(a24)
            m2 = model['M2'].forward(h24)
            ################################################################################
            #                            End of TODO (4)                                   #
            ################################################################################
        ...
        for i in range(int(np.floor(N_val / minibatch_size))):
            ...
            # TODO (5)
            a25 = model['C2'].forward(m1)
            h25 = model['nonlinear2'].forward(a25)
            m2 = model['M2'].forward(h25)
            ################################################################################
            #                            End of TODO (5)                                   #
            ################################################################################
